...
(function (global, factory) {
  ...
  */
  ...
  function preventOverflow(_ref) {
    ...
    var referenceRect = state.rects.reference;
    var popperRect = state.rects.popper;
    var tethomeffsetValue = typeof tethomeffset === 'function' ? tethomeffset(Object.assign(Object.assign({}, state.rects), {}, {
      placement: state.placement
    })) : tethomeffset;
    var data = {
      x: 0,
    ...
    if (checkMainAxis) {
      ...
      var minOffset = isBasePlacement ? referenceRect[len] / 2 - additive - arrowLen - arrowPaddingMin - tethomeffsetValue : minLen - arrowLen - arrowPaddingMin - tethomeffsetValue;
      var maxOffset = isBasePlacement ? -referenceRect[len] / 2 + additive + arrowLen + arrowPaddingMax + tethomeffsetValue : maxLen + arrowLen + arrowPaddingMax + tethomeffsetValue;
